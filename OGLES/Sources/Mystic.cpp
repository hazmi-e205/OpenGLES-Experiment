...
Matrix & Matrix::SetFrustum(float l, float r, float b, float t, float n, float f)
{
    //Source: https://github.com/datenwolf/linmath.h/blob/master/linmath.h
    m[0][0] = 2.f*n/(r-l);
...
Matrix & Matrix::SetOrtho(float l, float r, float b, float t, float n, float f)
{
    //Source: https://github.com/datenwolf/linmath.h/blob/master/linmath.h
    m[0][0] = 2.f/(r-l);
    m[0][1] = m[0][2] = m[0][3] = 0.f;
...
Matrix Matrix::Inverse()
{
    ...
    //float b11 = (m[2][2]*m[3][3]*m[4][4]) +(m[2][3]*m[3][4]*m[4][2]) + (m[2][4]*m[3][2]*m[4][3]) -
    //	(m[2][2]*m[3][4]*m[4][3]) - (m[2][3]*m[3][2]*m[4][4]) - (m[2][4]*m[3][3]*m[4][2]);

    //float b12 = (m[1][2]*m[3][4]*m[4][3]) +(m[1][3]*m[3][2]*m[4][4]) + (m[1][4]*m[3][3]*m[4][2]) -
    //	(m[1][2]*m[3][3]*m[4][4]) - (m[1][3]*m[3][4]*m[4][2]) - (m[1][4]*m[3][2]*m[4][3]);

    //float b13 = (m[1][2]*m[2][3]*m[4][4]) +(m[1][3]*m[2][4]*m[4][2]) + (m[1][4]*m[2][2]*m[4][3]) -
    //	(m[1][2]*m[2][4]*m[4][3]) - (m[1][3]*m[2][2]*m[4][4]) - (m[1][4]*m[2][3]*m[4][2]);

    //float b14 = (m[1][2]*m[2][4]*m[3][3]) +(m[1][3]*m[2][2]*m[3][4]) + (m[1][4]*m[2][3]*m[3][2]) -
    //	(m[1][2]*m[2][3]*m[3][4]) - (m[1][3]*m[2][4]*m[3][2]) - (m[1][4]*m[2][2]*m[3][3]);

    //float b21 = (m[2][1]*m[3][4]*m[4][3]) +(m[2][1]*m[3][1]*m[4][4]) + (m[2][4]*m[3][3]*m[4][1]) -
    //	(m[2][1]*m[3][3]*m[4][4]) - (m[2][3]*m[3][4]*m[4][1]) - (m[2][4]*m[3][1]*m[4][3]);

    //float b22 = (m[1][1]*m[3][3]*m[4][4]) +(m[1][3]*m[3][4]*m[4][1]) + (m[1][4]*m[3][1]*m[4][3]) -
    //	(m[1][1]*m[3][4]*m[4][3]) - (m[1][3]*m[3][1]*m[4][4]) - (m[1][4]*m[3][3]*m[4][1]);

    //rumus projection muke gile
    res.m[0][0] = 1.0/m[0][0];
    res.m[1][0] = m[1][0];
    res.m[2][0] = m[2][0];
    res.m[3][0] = m[3][0];
    ...
    res.m[1][2] = m[1][2];
    res.m[2][2] = 0;
    res.m[3][2] = m[3][2]/(m[3][2]*m[2][3]);

    res.m[0][3] = m[0][3] ;
    res.m[1][3] = m[1][3] ;
    res.m[2][3] = m[2][3]/(m[3][2]*m[2][3]);
    res.m[3][3] = -(m[2][2]/(m[3][2]*m[2][3]));
